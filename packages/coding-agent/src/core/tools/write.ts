...
export function createWriteToolDefinition(
	...
	return {
		...
		promptGuidelines: [
			"Use write for new files. To change a file that already exists, use edit instead.",
			"Rewriting a whole file spends one output token per line you reproduce, so it is far slower than an edit and risks corrupting the parts that were already correct.",
		],
