...
import { createDefaultWebSearchOperations, type WebSearchOperations } from "./tools/web-search.ts";
...
export interface CreateAgentSessionOptions {
	 ...
	 * - "builtin": disable the default built-in tools, including the core coding tools and internal
	 *   orchestration tools, but keep extension/custom tools enabled
	 */
	noTools?: "all" | "builtin";
	/**
	...
	/** Web search backend. Defaults to Tavily when TAVILY_API_KEY is set; omitted otherwise. */
...
export type { WebSearchOperations, WebSearchResultItem } from "./tools/web-search.ts";
