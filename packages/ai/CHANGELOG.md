...
- Added shared final-request context budgets and model/system/tool/message fingerprints for validating historical usage anchors.
...
- Changed output-limit clipping to share the context preflight estimate and safety margin, including newly appended tool results.
